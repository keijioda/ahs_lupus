...
* Five logistic models were fitted using prevalent SLE as the outcome.
  ...
  * Model 5 further adds BMI categories and energy intake (kcal as continuous)
...
* To examine the effect of post-menopause, an interaction term between gender (0 = Male; 1 = Female) and menopausal status (0 = Pre-menopause, including men; 1 = Post-menopause) was included into the models above.
  ...
  * In the last model, the OR associated with gender compares **pre-menopausal** women against men. However, in Model 1-4, this OR for gender compares **all women** against men.
